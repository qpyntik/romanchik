...
set t1.bank = t2.bank,
    t1.branch = t2.branch,
    t1.contractType = t2.contractType,
    t1.gr = t2.gr,
    t1.currency = t2.currency,
    t1.BalAll = t2.BalAll,
    t1.BalBody = t2.Bal + t2.overdr,
    t1.ExAge = t2.ExAge
...
set t1.bank = t2.bank,
    ...
    t1.ExAge = t2.ExAge
from RESTR._tClientsPullRestr as t1 
join tmp.tSybridgeCreditRestr as t2 
...
join RESTR._tClientsPullRestr as t2 
	on t1.clientid = t2.clientid and t1.refcontract = t2.refcontract 
join tmp.tSybridgeCreditRestr as t3 
...
-- договора с  contracttypeplat='PDL1' и refcontractplat like 'SAMDP%'
update RESTR.tReasonNotRestr 
set t1.LimitOnZP = 'Y'
from RESTR.tReasonNotRestr as t1 
join RESTR._tClientsPullRestr as t2 
	on t1.clientid = t2.clientid and t1.refcontract = t2.refcontract
	and t2.fl = 'P48'
join RM.tCards as t3
	on t3.clientid = t2.clientid and t3.refcontract = t2.refcontract
	and t3.Contracttype='PDL1'
